"""
Django settings for coloc_meal_planner project.
...
INSTALLED_APPS = [
    ...
    'meal_planner',  # Notre application
    'django_select2',
]
...
ROOT_URLCONF = 'coloc_meal_planner.urls'
...
WSGI_APPLICATION = 'coloc_meal_planner.wsgi.application'
